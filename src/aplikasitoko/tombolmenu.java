 ...
 * @author usu
 */
public class tombolmenu extends JButton {
    ...
    public tombolmenu() {
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/aplikasitoko/gambar/burn.gif"));
    ...
    protected void paintComponent(Graphics g) {
        Color light = new Color(1F, 1F, 1F, 0.7F);
