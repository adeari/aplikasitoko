 ...
 * @author amy
 */
public class tbkostumer extends Frame {

    /** Creates new form tbkustomer */
    public tbkostumer() {
    ...
    private void initComponents() {
        ...
        panelimagetbbarang1 = new aplikasitoko.panelimagetbbarang("/aplikasitoko/gambar/customer.jpg");
        ...
        final String kolom[]={"Kode Kustomer","Nama Kustomer","Alamat","Telepon"};
        ...
        tc=tabel.getColumn("Kode Kustomer");
        tc.setMinWidth(230);
        ...
        tc=tabel.getColumn("Nama Kustomer");
        ...
        kd_kos = new aplikasitoko.textFieldStyle();
        jLabel3 = new javax.swing.JLabel();
        nama_kos = new aplikasitoko.textFieldStyle();
        ...
        tabel.setToolTipText("Data Kostumer");
        ...
        jLabel2.setText("Kode Kostumer");
        pnSimpan.add(jLabel2);
        jLabel2.setBounds(20, 90, 200, 50);

        kd_kos.setName("kd_kos"); // NOI18N
        kd_kos.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                kd_kosKeyReleased(evt);
            }
        });
        pnSimpan.add(kd_kos);
        kd_kos.setBounds(250, 90, 430, 47);

        jLabel3.setFont(new java.awt.Font("Arial", 1, 25));
        jLabel3.setForeground(new java.awt.Color(0, 51, 51));
        jLabel3.setText("Nama Kostumer");
        pnSimpan.add(jLabel3);
        jLabel3.setBounds(20, 140, 200, 50);

        nama_kos.setName("usr"); // NOI18N
        nama_kos.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                nama_kosKeyReleased(evt);
            }
        });
        pnSimpan.add(nama_kos);
        nama_kos.setBounds(250, 140, 660, 47);
        ...
        lbsimpantext.setText("TAMBAH DATA KOSTUMER");
...
private void btSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSimpanActionPerformed
    String qry = "";
        if (lbsimpantext.getText().equalsIgnoreCase("TAMBAH DATA KOSTUMER")) {
            qry = "select count(kd_kos) as jumlah from tb_kostumer where kd_kos=" + fsu.fixSqlCharacter(kd_kos.getText());
            try {
                ...
                if (rs.next()) {
                    if (rs.getInt("jumlah") > 0) {
                        javax.swing.JOptionPane.showMessageDialog(null, "Kode Kostumer ini telah terpakai", "Pesan", 1);
                    } else {
                        qry = "insert into tb_kostumer (kd_kos,nama_kos,alamat,tlp) "
                                + " values (" + fsu.fixSqlCharacter(kd_kos.getText())
                                + "," + fsu.fixSqlCharacter(nama_kos.getText())
                                + "," + fsu.fixSqlCharacter(alamat.getText())
                                + "," + fsu.fixSqlCharacter(tlp.getText())
                                + ");";
                        if (fsu.idebugging) {
                            System.out.println(" simpankostumer " + qry);
                        }
        ...
        } else if (lbsimpantext.getText().equalsIgnoreCase("UBAH DATA KOSTUMER")) {
            try {
                Class.forName(fsu.klas).newInstance();
                Connection con = DriverManager.getConnection(fsu.klaSS);
                Statement stin = con.createStatement();
                qry = "update tb_kostumer set nama_kos=" + fsu.fixSqlCharacter(nama_kos.getText())
                        + ",alamat=" + fsu.fixSqlCharacter(alamat.getText())
                        + ",tlp=" + fsu.fixSqlCharacter(tlp.getText())
                        + " where kd_kos=" + fsu.fixSqlCharacter(kd_kos.getText());
                stin.executeUpdate(qry);
                lihat();
                btBatalActionPerformed(null);
                stin.close();
...
private void kd_kosKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kd_kosKeyReleased
    if (evt.getKeyCode() == evt.VK_ENTER) {
        nama_kos.requestFocus();
    }
}//GEN-LAST:event_kd_kosKeyReleased

private void nama_kosKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nama_kosKeyReleased
    if (evt.getKeyCode() == evt.VK_ENTER) {
        alamat.requestFocus();
    }
}//GEN-LAST:event_nama_kosKeyReleased

private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
    if (evt.getClickCount() == 2) {
        glasspanel1.setVisible(true);
        kd_kos.setText(tabel.getValueAt(tabel.getSelectedRow(), 0).toString());
        kd_kos.setEditable(false);
        nama_kos.requestFocus();
        lbsimpantext.setText("UBAH DATA KOSTUMER");
        btSimpan.setText("UBAH");
        btSimpan.setMnemonic('U');
        String qry = "select nama_kos,alamat,tlp "
                + "from tb_kostumer "
                + "where kd_kos=" + fsu.fixSqlCharacter(kd_kos.getText());
        try {
            Class.forName(fsu.klas).newInstance();
            ...
            ResultSet rs = sta.executeQuery(qry);
            if (rs.next()) {
                nama_kos.setText(fsu.ceknull(rs.getString("nama_kos")));
...
private void tabelKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabelKeyReleased
    if (evt.getKeyCode() == evt.VK_DELETE) {
        if (javax.swing.JOptionPane.showConfirmDialog(null, "Hapus data Kostumer ini?", "Perhatian",
            ...
            try {
                ...
                qry = "delete from tb_kostumer where kd_kos in (" + qry + ");";
                stin.executeUpdate(qry);
                lihat();
                btBatalActionPerformed(null);
                stin.close();
...
if (evt.getKeyCode() == evt.VK_TAB) {
    ...
    private aplikasitoko.textFieldStyle kd_kos;
    ...
    private aplikasitoko.textFieldStyle nama_kos;
    ...
    private void lihat() {
        ...
        if (txCari.getText().length() > 0) {
            kondisi = " where kd_kos like '%" + StringEscapeUtils.escapeSql(txCari.getText())
                    + "%'nama_kos like '%" + StringEscapeUtils.escapeSql(txCari.getText())
