 ...
 * @author amy
 */
public class trxjual extends Frame {
    ...
    public trxjual() {
        ...
        glasspanel3.showPanelii(pnSimpanBarang, 30, 50, pnSimpanBarang.getWidth() + 1000, pnSimpanBarang.getHeight() + 550);
    ...
    private void initComponents() {
        ...
        final String kolom[]={"Nota Penjualan","Tanggal","Tanggal\nJatuh Tempo","Kode Kostumer","Nama Kostumer"};
        ...
        tc=tabel.getColumn("Nota Penjualan");
        tc.setMinWidth(220);
        ...
        tc=tabel.getColumn("Kode Kostumer");
        tc.setMinWidth(230);tc.setHeaderRenderer(headerrender);
        tc=tabel.getColumn("Nama Kostumer");
        tc.setMinWidth(320);tc.setHeaderRenderer(headerrender);
        ...
        final String kolomtrx[]={"No.","Kode Barang","Nama Barang","Banyaknya","Harga Jual","Diskon","Harga Diskon","Total Harga Jual"};
        ...
        tc.setMinWidth(170);tc.setHeaderRenderer(headertrx);
        tc=tbtransaksi.getColumn("Nama Barang");
        tc.setMinWidth(190);tc.setHeaderRenderer(headertrx);
        tc=tbtransaksi.getColumn("Banyaknya");
        tc.setMinWidth(150);tc.setHeaderRenderer(headertrx);
        tc=tbtransaksi.getColumn("Harga Jual");
        tc.setMinWidth(160);tc.setHeaderRenderer(headertrx);
        tc=tbtransaksi.getColumn("Diskon");
        tc.setMinWidth(90);tc.setHeaderRenderer(headertrx);
        tc=tbtransaksi.getColumn("Harga Diskon");
        tc.setMinWidth(180);tc.setHeaderRenderer(headertrx);
        tc=tbtransaksi.getColumn("Total Harga Jual");
        tc.setMinWidth(200);tc.setHeaderRenderer(headertrx);
        tbtransaksi.setDefaultRenderer(Object.class, new rendertaabel_trxjual());
        ...
        tglJTempo = new aplikasitoko.textMasking();
        ...
        final String kolom1[]={"Kode Kostumer","Nama Kostumer","Alamat","Telepon"};
        ...
        tc=tabel1.getColumn("Kode Kostumer");
        tc.setMinWidth(230);
        ...
        tc=tabel1.getColumn("Nama Kostumer");
        ...
        diskon = new aplikasitoko.numberfield();
        ...
        hrg_diskon = new aplikasitoko.numberfield();
        jLabel15 = new javax.swing.JLabel();
        jLabel16 = new javax.swing.JLabel();
        stok = new aplikasitoko.numberfield();
        jLabel17 = new javax.swing.JLabel();
        total_hrg_jual = new aplikasitoko.numberfield();
        hrg_jual = new aplikasitoko.numberfield();
...
dateChooserDialog2.addSelectionChangedListener(new datechooser.events.SelectionChangedListener() {
    ...
    tabel.setToolTipText("TRANSAKSI PENJUALAN");
    ...
    limitnih.setFont(new java.awt.Font("Arial", 1, 25));
    ...
    labelklip2.setText("TRANSAKSI PENJUALAN");
    ...
    lbsimpantext.setText("TAMBAH TRANSAKSI JUAL");
    ...
    pilihTgl.setBounds(350, 50, 70, 50);
    ...
    jLabel6.setText("Nama Kostumer");
    pnSimpan.add(jLabel6);
    jLabel6.setBounds(30, 160, 210, 50);
    ...
    pilihsuplier.setText("Pilih Kostumer");
    ...
    pnSimpan.add(jLabel12);
    jLabel12.setBounds(710, 50, 270, 35);

    tglJTempo.addKeyListener(new java.awt.event.KeyAdapter() {
        public void keyReleased(java.awt.event.KeyEvent evt) {
            tglJTempoKeyReleased(evt);
        }
    });
    pnSimpan.add(tglJTempo);
    tglJTempo.setBounds(990, 50, 180, 47);
    ...
    pnSimpan.add(pilihTgl1);
    pilihTgl1.setBounds(1190, 50, 70, 50);
    ...
    limitnih1.setFont(new java.awt.Font("Arial", 1, 25));
    ...
    jLabel7.setBounds(20, 200, 200, 50);
    ...
    nama_brg.setBounds(230, 100, 440, 47);
    ...
    pnSimpanBarang.add(diskon);
    diskon.setBounds(230, 300, 110, 47);
    ...
    btSimpan1.setBounds(130, 480, 230, 60);
    ...
    btBatal1.setBounds(390, 480, 220, 58);

    lbsimpantext1.setText("TAMBAH PENJUALAN BARANG");
    lbsimpantext1.setFont(new java.awt.Font("Arial", 1, 36));
    pnSimpanBarang.add(lbsimpantext1);
    lbsimpantext1.setBounds(90, 0, 620, 50);

    jLabel13.setFont(new java.awt.Font("Arial", 1, 25));
    jLabel13.setForeground(new java.awt.Color(0, 51, 51));
    jLabel13.setText("Stok");
    pnSimpanBarang.add(jLabel13);
    jLabel13.setBounds(20, 250, 200, 50);
    ...
    pnSimpanBarang.add(hrg_beli);
    hrg_beli.setBounds(230, 150, 310, 47);

    jLabel14.setFont(new java.awt.Font("Arial", 1, 25));
    jLabel14.setForeground(new java.awt.Color(0, 51, 51));
    jLabel14.setText("%");
    pnSimpanBarang.add(jLabel14);
    jLabel14.setBounds(350, 300, 40, 50);

    hrg_diskon.setEditable(false);
    pnSimpanBarang.add(hrg_diskon);
    hrg_diskon.setBounds(230, 350, 310, 47);

    jLabel15.setFont(new java.awt.Font("Arial", 1, 25));
    jLabel15.setForeground(new java.awt.Color(0, 51, 51));
    jLabel15.setText("Diskon");
    pnSimpanBarang.add(jLabel15);
    jLabel15.setBounds(20, 300, 200, 50);
    ...
    pnSimpanBarang.add(jLabel16);
    jLabel16.setBounds(20, 350, 200, 50);
    ...
    pnSimpanBarang.add(stok);
    stok.setBounds(230, 250, 310, 47);

    jLabel17.setFont(new java.awt.Font("Arial", 1, 25));
    jLabel17.setForeground(new java.awt.Color(0, 51, 51));
    jLabel17.setText("Total Harga Jual");
    pnSimpanBarang.add(jLabel17);
    jLabel17.setBounds(20, 400, 200, 50);

    total_hrg_jual.setEditable(false);
    pnSimpanBarang.add(total_hrg_jual);
    total_hrg_jual.setBounds(230, 400, 310, 47);

    hrg_jual.addKeyListener(new java.awt.event.KeyAdapter() {
        public void keyReleased(java.awt.event.KeyEvent evt) {
            hrg_jualKeyReleased(evt);
        }
    });
    pnSimpanBarang.add(hrg_jual);
    hrg_jual.setBounds(230, 200, 310, 47);
    ...
    pilihsuplier1.setBounds(533, 47, 260, 50);
    ...
    limitnih2.setFont(new java.awt.Font("Arial", 1, 25));
...
private void buttonStyle1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonStyle1ActionPerformed
    ...
    tglJTempo.setText(sdf.format(dt));
    kd_org = "";
    namasuplier.setText("");
    ...
    try {
        ...
        Statement staexec = con.createStatement();
            ResultSet rs = staexec.executeQuery("select kd_brg from tb_trxjual2 where nambah and kd_user=" + pemakai);
            while (rs.next()) {
                normalBarang(rs.getString("kd_brg"));
            }
            staexec.close();
        sta.executeUpdate("delete from tb_trxjual2 where kd_user=" + pemakai);
...
private void btBatalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBatalActionPerformed
    ...
    try {
        ...
        Connection con = DriverManager.getConnection(fsu.klaSS);
        Statement sta = con.createStatement();
        if (lbsimpantext.getText().equalsIgnoreCase("TAMBAH TRANSAKSI JUAL")) {
            Statement staexec = con.createStatement();
            ResultSet rs = staexec.executeQuery("select kd_brg from tb_trxjual2 where nambah and kd_user=" + pemakai);
            while (rs.next()) {
                normalBarang(rs.getString("kd_brg"));
...
private void btSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSimpanActionPerformed
    ...
    if (lbsimpantext.getText().equalsIgnoreCase("TAMBAH TRANSAKSI JUAL")) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                qry = "insert into tb_trxjual (nota,kd_kos,tanggal,tgljatuhtempo) values ("
                        + fsu.fixSqlCharacter(notaid.getText()) + ","
                        + fsu.fixSqlCharacter(kd_org) + ",STR_TO_DATE("
                        + fsu.fixSqlCharacter(tgl.getText()) + ", '%d/%m/%Y'),STR_TO_DATE("
                        + fsu.fixSqlCharacter(tglJTempo.getText()) + ", '%d/%m/%Y'));";
                if (fsu.idebugging) {
                    System.out.println(" simpan trx jual " + qry);
                }
                stin.executeUpdate(qry);
                int ratahrg_beli = 0, stokbaru = 0, hrgBaru = 0;
                qry = "select kd_brg,hrg_beli,nama_brg,hrg_jual,selisih,stok,kd_hrgbeli,totaljual,discount"
                        + " from tb_trxjual2 where kd_user=" + pemakai + " order by urutan";
                rs = sta.executeQuery(qry);
                while (rs.next()) {
                    qry = "insert into tb_trxjual1 (nota,kd_brg,hrg_beli,hrg_jual,selisih,stok,kd_hrgbeli,totaljual,discount) values ("
                            + fsu.fixSqlCharacter(notaid.getText()) + ","
                            + fsu.fixSqlCharacter(rs.getString("kd_brg")) + ","
                            + fsu.fixSqlNumber(rs.getString("hrg_beli")) + ","
                            + fsu.fixSqlNumber(rs.getString("hrg_jual")) + ","
                            + fsu.fixSqlNumber(rs.getString("selisih")) + ","
                            + fsu.fixSqlNumber(rs.getString("stok")) + ","
                            + fsu.fixSqlCharacter(rs.getString("kd_hrgbeli")) + ","
                            + fsu.fixSqlNumber(rs.getString("totaljual")) + ","
                            + fsu.fixSqlNumber(rs.getString("discount"))
                            + ")";
                    if (fsu.idebugging) {
                        System.out.println(" simpan trx jual 5643 " + qry);
                    }
                    stin.executeUpdate(qry);
                    if (getStok(rs.getString("kd_brg")) == -1) {
                        qry = "insert into tb_barang (kd_brg,nama_brg,satuan,hrg_beli,hrg_jual_grosir,hrg_jual_retail,stok,kd_hrgbeli) values ("
                                + fsu.fixSqlCharacter(rs.getString("kd_brg")) + ","
                                ...
                                + ")";
                        if (fsu.idebugging) {
                            System.out.println(" simpan trx jual 5356 " + qry);
                        }
                        stin.executeUpdate(qry);
                    } else {
                        qry = "update tb_barang set stok=stok-" + fsu.fixSqlNumber(rs.getString("stok"))
                                + " where kd_brg=" + fsu.fixSqlCharacter(rs.getString("kd_brg"));
                        if (fsu.idebugging) {
                            System.out.println(" simpan trx jual 3535 " + qry);
                        }
                        stin.executeUpdate(qry);
                    }
                }
    ...
    } else if (lbsimpantext.getText().equalsIgnoreCase("UBAH TRANSAKSI JUAL")) {
        try {
            Class.forName(fsu.klas).newInstance();
            Connection con = DriverManager.getConnection(fsu.klaSS);
            Statement stin = con.createStatement();
            qry = "update tb_trxjual set kd_kos=" + fsu.fixSqlCharacter(kd_org)
                    + ",tanggal=STR_TO_DATE("
                    + fsu.fixSqlCharacter(tgl.getText())
                    + ",'%d/%m/%Y'),tgljatuhtempo=STR_TO_DATE(" + fsu.fixSqlCharacter(tglJTempo.getText()) + ", '%d/%m/%Y') "
                    + "where nota=" + fsu.fixSqlCharacter(notaid.getText());
            if (fsu.idebugging) {
                System.out.println("cek ubah trxjual "+qry);
            }
            stin.executeUpdate(qry);
...
private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
    if (evt.getClickCount() == 2) {
        ...
        glasspanel1.setVisible(true);
        notaid.requestFocus();
        lbsimpantext.setText("UBAH TRANSAKSI JUAL");
        ...
        tglJTempo.setText(tabel.getValueAt(tabel.getSelectedRow(), 2).toString());
        btCetak.setEnabled(true);
        String qry = "select kd_kos,nama_kos,alamat,tlp "
                + "from tb_kostumer "
                + "where kd_kos=(select kd_kos from tb_trxjual where nota="
        ...
        try {
            ...
            ResultSet rs = sta.executeQuery(qry);
            if (rs.next()) {
                kd_org = rs.getString("kd_kos");
                namasuplier.setText(fsu.ceknull(rs.getString("nama_kos")));
            ...
            stin.executeUpdate(qry);
            qry = "select a.kd_brg,b.nama_brg,a.hrg_beli,a.hrg_jual,a.selisih,a.stok,a.kd_hrgbeli,a.totaljual,a.discount "
                    + " from tb_trxjual1 a inner join tb_barang b on a.kd_brg=b.kd_brg where a.nota="
                    + fsu.fixSqlCharacter(tabel.getValueAt(tabel.getSelectedRow(), 0).toString());
            if (fsu.idebugging) {
                System.out.println("cek tabelMouseClicked " + qry);
            }
            rs = sta.executeQuery(qry);
            int i = 0, hrg_diskon = 0;;
            while (rs.next()) {
                i++;
                hrg_diskon = rs.getInt("hrg_jual") - (rs.getInt("hrg_jual") * rs.getInt("discount") / 100);
                qry = "insert into tb_trxjual2 (kd_user,urutan,kd_brg,nama_brg,hrg_beli,hrg_jual,"
                        + "selisih,stok,kd_hrgbeli,totaljual,discount,hrg_diskon,nambah) values (" + pemakai + "," + i + ","
                        + fsu.fixSqlCharacter(rs.getString("kd_brg")) + ","
                        + fsu.fixSqlCharacter(rs.getString("nama_brg")) + ","
                        + fsu.fixSqlNumber(rs.getString("hrg_beli")) + ","
                        + fsu.fixSqlNumber(rs.getString("hrg_jual")) + ","
            ...
            if (fsu.idebugging) {
                System.out.println(" error simpan trxjual " + ex.getMessage());
            }
        }
    }
...
private void pilihNotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihNotaActionPerformed
    ...
    try {
        ...
        Connection con = DriverManager.getConnection(fsu.klaSS);
        Statement sta = con.createStatement();
        String qry = "select max(nota) as ini from tb_trxjual where nota like '" + kode + "%';";
        if (fsu.idebugging) {
        ...
        if (fsu.idebugging) {
            System.out.println(" error enter tb_trxjual lihat " + ex.getMessage());
        }
    }
    notaid.setText(kode);
...
private void buttonStyle2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonStyle2ActionPerformed
    ...
    stok.setText("0");
    diskon.setText("0");
    hrg_diskon.setText("0");
    total_hrg_jual.setText("0");
    lbsimpantext1.setText("TAMBAH PENJUALAN BARANG");
    btSimpan1.setText("SIMPAN");
...
private void btSimpan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSimpan1ActionPerformed
    String qry = "";
    int selisih = Integer.valueOf(fsu.fixSqlNumber(hrg_diskon.getText())) - Integer.valueOf(fsu.fixSqlNumber(hrg_beli.getText()));
    selisih *= Integer.valueOf(fsu.fixSqlNumber(stok.getText()));
    if (lbsimpantext1.getText().equalsIgnoreCase("UBAH PENJUALAN BARANG")) {
        normalBarang(kd_barang.getText());
    }
    boolean bisa = true;
    if (kd_barang.getText().length() < 1 && bisa) {
        bisa = false;
        kd_barang.requestFocus();
        javax.swing.JOptionPane.showMessageDialog(null, "Isi Kode Barang", "Pesan", 1);
    }
    if (nama_brg.getText().length() < 1 && bisa) {
        bisa = false;
        nama_brg.requestFocus();
        javax.swing.JOptionPane.showMessageDialog(null, "Isi Nama Barang", "Pesan", 1);
    }
    if (Integer.valueOf(fsu.fixSqlNumber(stok.getText())) < 1 && bisa) {
        bisa = false;
        stok.requestFocus();
        javax.swing.JOptionPane.showMessageDialog(null, "Jumlah Barang yang di jual belum di isi", "Pesan", 1);
    }
    if (fsu.idebugging) {
        System.out.println("stok skr 1 " + getStok(kd_barang.getText()));
    }
    if (Integer.valueOf(fsu.fixSqlNumber(stok.getText())) > getStok(kd_barang.getText())
            && getStok(kd_barang.getText()) > -1
            && bisa) {
        if (lbsimpantext1.getText().equalsIgnoreCase("UBAH PENJUALAN BARANG")) {
            balikinBarang(kd_barang.getText());
        }
        bisa = false;
        stok.requestFocus();
        javax.swing.JOptionPane.showMessageDialog(null, "Stok barang tidak cukup", "Pesan", 1);
    }
    if (selisih == 0 && bisa) {
        if (javax.swing.JOptionPane.showConfirmDialog(null, "Apakah tidak ingin untung\nKarena Harga beli = Harga jual?", "Perhatian",
                javax.swing.JOptionPane.YES_NO_OPTION,
    ...
    if (selisih < 0 && bisa) {
        if (javax.swing.JOptionPane.showConfirmDialog(null, "Total Harga Jual Rp." + total_hrg_jual.getText() + " lebih kecil daripada Total Harga beli Rp."
                + fsu.ceknullangka(String.valueOf((Integer.valueOf(fsu.fixSqlNumber(hrg_beli.getText()))
                * Integer.valueOf(fsu.fixSqlNumber(stok.getText())))))
                + "\nTotal kerugian Rp." + fsu.ceknullangka(String.valueOf(selisih * -1)) + ".\n     Apakah ingin merugi?", "Perhatian",
                javax.swing.JOptionPane.YES_NO_OPTION,
                javax.swing.JOptionPane.QUESTION_MESSAGE) == javax.swing.JOptionPane.NO_OPTION) {
            bisa = false;
            hrg_jual.requestFocus();
    ...
    if (bisa) {
        if (lbsimpantext1.getText().equalsIgnoreCase("TAMBAH PENJUALAN BARANG")) {
            try {
                Class.forName(fsu.klas).newInstance();
                Connection con = DriverManager.getConnection(fsu.klaSS);
                Statement stin = con.createStatement();
                Statement sta = con.createStatement();
                int urutan = 0, total = Integer.valueOf(fsu.fixSqlNumber(hrg_beli.getText()));
                total = total * Integer.valueOf(fsu.fixSqlNumber(diskon.getText()));

                qry = "select kd_brg from tb_trxjual2 where kd_brg=" + fsu.fixSqlCharacter(kd_barang.getText()) + " and kd_user=" + pemakai;
                ResultSet rs = sta.executeQuery(qry);
                if (rs.next()) {
                    javax.swing.JOptionPane.showMessageDialog(null, "Barang ini telah terdaftar", "Pesan", 1);
                } else {
                    qry = "select max(urutan) as urutan from tb_trxjual2 where kd_user=" + pemakai;
                    rs = sta.executeQuery(qry);
                    if (rs.next()) {
                    ...
                    qry = "insert into tb_trxjual2 (urutan,kd_user,kd_brg,nama_brg,hrg_beli,"
                            + "stok,kd_hrgbeli,hrg_jual,totaljual,discount,selisih,hrg_diskon,nambah) values (" + urutan + "," + pemakai + ","
                            + fsu.fixSqlCharacter(kd_barang.getText())
                            + "," + fsu.fixSqlCharacter(nama_brg.getText()) + "," + fsu.fixSqlNumber(hrg_beli.getText())
                            + "," + fsu.fixSqlNumber(stok.getText()) + ","
                            + fsu.fixSqlCharacter(fsu.pengkodean(fsu.fixSqlNumber(hrg_beli.getText()))) + ","
                            + fsu.fixSqlNumber(hrg_jual.getText()) + ","
                            + fsu.fixSqlNumber(total_hrg_jual.getText()) + ","
                            + fsu.fixSqlNumber(diskon.getText()) + "," + String.valueOf(selisih) + "," + fsu.fixSqlNumber(hrg_diskon.getText())
                            + ",1)";
                    if (fsu.idebugging) {
                        System.out.println(" simpan " + qry);
                    }
                    stin.executeUpdate(qry);
                    qry = "update tb_barang set stok=stok-" + fsu.fixSqlNumber(stok.getText()) + " where kd_brg=" + fsu.fixSqlCharacter(kd_barang.getText());
                    stin.executeUpdate(qry);
                    lihattrx();
        ...
        } else if (lbsimpantext1.getText().equalsIgnoreCase("UBAH PENJUALAN BARANG")) {
            try {
                Class.forName(fsu.klas).newInstance();
                Connection con = DriverManager.getConnection(fsu.klaSS);
                Statement stin = con.createStatement();
                int total = Integer.valueOf(fsu.fixSqlNumber(hrg_beli.getText()));
                total = total * Integer.valueOf(fsu.fixSqlNumber(diskon.getText()));
                qry = "update tb_trxjual2 set hrg_beli=" + fsu.fixSqlNumber(hrg_beli.getText())
                        + ",stok=" + fsu.fixSqlNumber(stok.getText())
                        + ",kd_hrgbeli=" + fsu.fixSqlCharacter(fsu.pengkodean(fsu.fixSqlNumber(hrg_beli.getText())))
                        + ",hrg_jual=" + fsu.fixSqlNumber(hrg_jual.getText())
                        + ",selisih= " + String.valueOf(selisih)
                        + ",discount=" + fsu.fixSqlNumber(diskon.getText())
                        + ",hrg_diskon=" + fsu.fixSqlNumber(hrg_diskon.getText())
                        + ",totaljual=" + fsu.fixSqlNumber(total_hrg_jual.getText())
                        + ",nambah=1"
                        + " where kd_user=" + pemakai + " and "
                        + " kd_brg=" + fsu.fixSqlCharacter(kd_barang.getText());

                stin.executeUpdate(qry);
                qry = "update tb_barang set stok=stok-" + fsu.fixSqlNumber(stok.getText())
                        + " where kd_brg=" + fsu.fixSqlCharacter(kd_barang.getText());
                stin.executeUpdate(qry);
    ...
    private int getStok(String kd_brg) {
        int balik = -1;
        try {
            Class.forName(fsu.klas).newInstance();
            Connection con = DriverManager.getConnection(fsu.klaSS);
            Statement sta = con.createStatement();
            String qry = "SELECT stok FROM tb_barang where kd_brg=" + fsu.fixSqlCharacter(kd_barang.getText());
            ResultSet rs = sta.executeQuery(qry);
            if (rs.next()) {
                balik = rs.getInt("stok");
            }
            rs.close();
            sta.close();
            con.close();
    ...
    private void balikinBarang(String kd_brg) {
        int balik = -1;
        try {
            Class.forName(fsu.klas).newInstance();
            Connection con = DriverManager.getConnection(fsu.klaSS);
            Statement sta = con.createStatement();
            String qry = "SELECT stok FROM tb_barang where kd_brg=" + fsu.fixSqlCharacter(kd_brg);
            ResultSet rs = sta.executeQuery(qry);
            if (rs.next()) {
                balik = rs.getInt("stok");
                qry = "SELECT stok FROM tb_trxjual2 where kd_brg=" + fsu.fixSqlCharacter(kd_brg) + " and nambah and kd_user=" + pemakai;
                rs = sta.executeQuery(qry);
                if (rs.next()) {
                    balik -= rs.getInt("stok");
                    qry = "update tb_barang set stok=" + balik + " where kd_brg=" + fsu.fixSqlCharacter(kd_brg);
                    Statement stin = con.createStatement();
                    stin.executeUpdate(qry);
                    stin.close();
                }
    ...
    private void normalBarang(String kd_brg) {
        int balik = -1;
        try {
            Class.forName(fsu.klas).newInstance();
            Connection con = DriverManager.getConnection(fsu.klaSS);
            ...
            String qry = "SELECT stok FROM tb_barang where kd_brg=" + fsu.fixSqlCharacter(kd_brg);
               if (fsu.idebugging) {
                    System.out.println("normal barang qry 1 "+qry);
                }
            ResultSet rs = sta.executeQuery(qry);
            if (rs.next()) {
                balik = rs.getInt("stok");
                if (fsu.idebugging) {
                    System.out.println("normal barang stok 1 "+balik);
                }
                qry = "SELECT stok FROM tb_trxjual2 where kd_brg=" + fsu.fixSqlCharacter(kd_brg) + " and nambah and kd_user=" + pemakai;
                
               if (fsu.idebugging) {
                    System.out.println("normal barang qry 2 "+qry);
                }
                rs = sta.executeQuery(qry);
                if (rs.next()) {
                    balik += rs.getInt("stok");
                    if (fsu.idebugging) {
                    System.out.println("normal barang stok 2 "+balik);
                }
                    qry = "update tb_barang set stok=" + balik + " where kd_brg=" + fsu.fixSqlCharacter(kd_brg);
                    if (fsu.idebugging) {
                    System.out.println("normal barang qry 3 "+qry);
                }
                    Statement stin = con.createStatement();
                    stin.executeUpdate(qry);
                    stin.close();
...
private void tabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel2MouseClicked
    if (evt.getClickCount() == 2) {
        if (tabel2.getSelectedColumn() == 3 || tabel2.getSelectedColumn() == 4) {
            ...
            hrg_jual.setText(tabel2.getValueAt(tabel2.getSelectedRow(), tabel2.getSelectedColumn()).toString());
            hrg_diskon.setText(tabel2.getValueAt(tabel2.getSelectedRow(), tabel2.getSelectedColumn()).toString());
            try {
                Class.forName(fsu.klas).newInstance();
                Connection con = DriverManager.getConnection(fsu.klaSS);
                Statement sta = con.createStatement();
            ...
            javax.swing.JOptionPane.showMessageDialog(null, "Klih Harga jual grosir \natau Harga jual Retail saja", "Pesan", 1);
        }
    }
...
private void kd_barangFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_kd_barangFocusLost
    if (lbsimpantext1.getText().equalsIgnoreCase("TAMBAH PENJUALAN BARANG")) {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection(fsu.klaSS);
            Statement sta = con.createStatement();
            String qry = "SELECT hrg_beli,nama_brg,hrg_jual_retail FROM tb_barang where kd_brg=" + fsu.fixSqlCharacter(kd_barang.getText());
            if (fsu.idebugging) {
            ...
            if (rs.next()) {
                if (!nama_brg.getText().equalsIgnoreCase(fsu.ceknull(rs.getString("nama_brg")))) {
                    ...
                    hrg_beli.setText(fsu.ceknullangka(rs.getString("hrg_beli")));
                    hrg_jual.setText(fsu.ceknullangka(rs.getString("hrg_jual_retail")));
                    stok.setText("0");
                    diskon.setText("0");
                    hrg_diskon.setText(fsu.ceknullangka(rs.getString("hrg_jual_retail")));
                    total_hrg_jual.setText("0");
                }
            } else {
                nama_brg.setText("");
...
private void tbtransaksiKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbtransaksiKeyReleased
    if (lbsimpantext.getText().equalsIgnoreCase("TAMBAH TRANSAKSI JUAL") && evt.getKeyCode() == evt.VK_DELETE) {
        if (javax.swing.JOptionPane.showConfirmDialog(null, "Hapus data barang ini?", "Perhatian",
            ...
            try {
                ...
                for (int x = 0; x < baris.length; x++) {
                    ...
                    normalBarang(tbtransaksi.getValueAt(baris[x], 1).toString());
                }
                qry = "delete from tb_trxjual2 where kd_brg in (" + qry + ") and kd_user=" + pemakai + ";";
                if (fsu.idebugging) {
...
private void tbtransaksiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbtransaksiMouseClicked
    if (lbsimpantext.getText().equalsIgnoreCase("TAMBAH TRANSAKSI JUAL") && evt.getClickCount() == 2) {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection(fsu.klaSS);
            Statement sta = con.createStatement();
            String qry = "SELECT hrg_beli FROM tb_trxjual2 where kd_brg=" + fsu.fixSqlCharacter(kd_barang.getText()) + " and kd_user=" + pemakai;
            if (fsu.idebugging) {
                System.out.println("kd_barangFocusLost  " + qry);
            }
            ResultSet rs = sta.executeQuery(qry);
            if (rs.next()) {
                hrg_beli.setText(rs.getString("hrg_beli"));
            }
            rs.close();
            sta.close();
            con.close();
        ...
        hrg_jual.setText(tbtransaksi.getValueAt(tbtransaksi.getSelectedRow(), 4).toString());
        stok.setText(tbtransaksi.getValueAt(tbtransaksi.getSelectedRow(), 3).toString());
        diskon.setText(tbtransaksi.getValueAt(tbtransaksi.getSelectedRow(), 5).toString().substring(0,
                (tbtransaksi.getValueAt(tbtransaksi.getSelectedRow(), 5).toString().length() - 2)));
        hrg_diskon.setText(tbtransaksi.getValueAt(tbtransaksi.getSelectedRow(), 6).toString());
        total_hrg_jual.setText(tbtransaksi.getValueAt(tbtransaksi.getSelectedRow(), 7).toString());
        lbsimpantext1.setText("UBAH PENJUALAN BARANG");
...
private void btCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCetakActionPerformed
    ...
    try {
        Class.forName(fsu.klas).newInstance();
        Connection con = DriverManager.getConnection(fsu.klaSS);
        String fileReport = fsu.getPath() + "rp_jualan.jasper";

        if (fsu.idebugging) {
            fileReport = "rp_jualan.jasper";
        }
        if (fsu.idebugging) {
        ...
        parameter.put("totalharga", lbTotal.getText());
         parameter.put("tgljatuhtempo", tglJTempo.getText());
    ...
    if (evt.getKeyCode() == evt.VK_DELETE) {
        if (javax.swing.JOptionPane.showConfirmDialog(null, "Hapus Data ini?", "Perhatian",
            ...
            try {
                ...
                qryi = "delete from tb_trxjual1 where nota in (" + qry + ");";
                if (fsu.idebugging) {
                    System.out.println("tbtransaksiKeyReleased  " + qryi);
                }
                sta.executeUpdate(qryi);
                qryi = "delete from tb_trxjual where nota in (" + qry + ");";
                if (fsu.idebugging) {
                    System.out.println("tbtransaksiKeyReleased  " + qryi);
                }
                sta.executeUpdate(qryi);
...
private void pilihTgl1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihTgl1ActionPerformed
    try {
        Date ini = (Date) sdf.parse(tglJTempo.getText());
        ...
        if (fsu.idebugging) {
            System.out.println("salah di pilihTgl1ActionPerformed " + ex.getMessage());
        }
    }
...
private void dateChooserDialog2OnSelectionChange(datechooser.events.SelectionChangedEvent evt) {//GEN-FIRST:event_dateChooserDialog2OnSelectionChange
    if (dateChooserDialog2.getSelectedDate() != null) {
        tglJTempo.setText(sdf.format(dateChooserDialog2.getSelectedDate().getTime()));
    }
...
private void tglKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tglKeyReleased
    if (evt.getKeyCode() == evt.VK_ENTER) {
        tglJTempo.requestFocus();
    }
}//GEN-LAST:event_tglKeyReleased

private void tglJTempoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tglJTempoKeyReleased
    if (evt.getKeyCode() == evt.VK_ENTER) {
        tgl.requestFocus();
    }
}//GEN-LAST:event_tglJTempoKeyReleased
...
private void stokKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_stokKeyReleased
    ...
    private void getTotalHarga() {
        ...
        total_hrg_jual.setText("0");
        //cek persen
        if (Integer.valueOf(fsu.fixSqlNumber(diskon.getText())) > 100) {
            diskon.setText("100");
        } else if  (Integer.valueOf(fsu.fixSqlNumber(diskon.getText())) < 0) {
            diskon.setText("0");
        }
        try {
            if (Integer.valueOf(fsu.fixSqlNumber(diskon.getText())) > 0) {
                jml = Integer.valueOf(fsu.fixSqlNumber(hrg_jual.getText())) * Integer.valueOf(fsu.fixSqlNumber(diskon.getText())) / 100;
                jml = Integer.valueOf(fsu.fixSqlNumber(hrg_jual.getText())) - jml;
                hasil = fsu.ceknullangka(String.valueOf(jml));
                hrg_diskon.setText(hasil);
            } else {
                hrg_diskon.setText(hrg_jual.getText());
            }
            jml = Integer.valueOf(fsu.fixSqlNumber(hrg_diskon.getText())) * Integer.valueOf(fsu.fixSqlNumber(stok.getText()));
            hasil = fsu.ceknullangka(String.valueOf(jml));
            total_hrg_jual.setText(hasil);
        } catch (Exception ex) {
        }
    }
private void hrg_jualKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_hrg_jualKeyReleased
    if (evt.getKeyCode() == evt.VK_ENTER) {
        stok.requestFocus();
    } else {
        getTotalHarga();
    }
}//GEN-LAST:event_hrg_jualKeyReleased
    ...
    private aplikasitoko.numberfield diskon;
    private aplikasitoko.numberfield hrg_beli;
    private aplikasitoko.numberfield hrg_diskon;
    private aplikasitoko.numberfield hrg_jual;
    ...
    private aplikasitoko.textMasking tglJTempo;
    private aplikasitoko.textFieldStyle tlp;
    private aplikasitoko.numberfield total_hrg_jual;
    ...
    private void lihat() {
        String qry = "", orderbi = " order by tanggal", kondisi = "";
        ...
        switch (kolompilih) {
            ...
            case 1:
                ...
                break;
            case 2:
                orderbi = " order by tgljatuhtempov ";
                break;
            case 3:
                orderbi = " order by kd_kos ";
            case 4:
                orderbi = " order by nama_kos ";
                break;
        }
        if (ascendi) {
            orderbi += " asc ";
        ...
        if (txCari.getText().length() > 0) {
            kondisi = " where nota like '%" + StringEscapeUtils.escapeSql(txCari.getText())
                    ...
                    + "%' or tgljatuhtempo like '%" + StringEscapeUtils.escapeSql(txCari.getText())
                    + "%' or nama_kos like '%" + StringEscapeUtils.escapeSql(txCari.getText())
                    + "%' or kd_kos like '%" + StringEscapeUtils.escapeSql(txCari.getText())
                    + "%'";
        }
        ...
        try {
            ...
            Connection con = DriverManager.getConnection(fsu.klaSS);
            Statement sta = con.createStatement();
            qry = "select count(*) as jumlah from (select nota,kd_kos,tanggal,tgljatuhtempo,nama_kos,tanggalv,tgljatuhtempov from "
                    + "((SELECT a.nota,a.kd_kos,date_format(a.tanggal,'%d/%m/%Y') as tanggal,"
                    + "date_format(a.tgljatuhtempo,'%d/%m/%Y') as tgljatuhtempo,a.tgljatuhtempo as tgljatuhtempov,"
                    + "b.nama_kos,a.tanggal as tanggalv "
                    + " from tb_trxjual a join tb_kostumer b on a.kd_kos=b.kd_kos) as aha) "
                    + kondisi + ") as ihi";
            if (fsu.idebugging) {
            ...
            qry = "select nota,kd_kos,tanggal,tgljatuhtempo,nama_kos,tanggalv,tgljatuhtempov from "
                    + "(SELECT a.nota,a.kd_kos,date_format(a.tanggal,'%d/%m/%Y') as tanggal,"
                    + "date_format(a.tgljatuhtempo,'%d/%m/%Y') as tgljatuhtempo,a.tgljatuhtempo as tgljatuhtempov,"
                    + "b.nama_kos,a.tanggal as tanggalv "
                    + " from tb_trxjual a join tb_kostumer b on a.kd_kos=b.kd_kos) as aha "
            ...
            while (rs.next()) {
                ...
                baris.addElement(fsu.ceknull(rs.getString("tgljatuhtempo")));
                baris.addElement(fsu.ceknull(rs.getString("kd_kos")));
                baris.addElement(fsu.ceknull(rs.getString("nama_kos")));
    ...
    private void lihat1() {
        ...
        if (fsu.idebugging) {
            System.out.println(" lihat data ini tb_kostumer " + posisi);
        }
        if (posisi == 0) {
        ...
        if (txCari1.getText().length() > 0) {
            kondisi = " where kd_kos like '%" + StringEscapeUtils.escapeSql(txCari1.getText())
                    + "%' nama_kos like '%" + StringEscapeUtils.escapeSql(txCari1.getText())
        ...
        try {
            ...
            Connection con = DriverManager.getConnection(fsu.klaSS);
            Statement sta = con.createStatement();
            qry = "select count(*) as jumlah from tb_kostumer " + kondisi;
            ResultSet rs = sta.executeQuery(qry);
            if (rs.next()) {
                if (rs.getInt("jumlah") > 0) {
            ...
            posisi2 = posisi * limit;
            opset = " limit " + posisi2 + " , " + String.valueOf(limit);
            qry = "SELECT kd_kos,nama_kos,alamat,tlp "
                    + "FROM tb_kostumer "
                    + kondisi + orderbi + opset;
            if (fsu.idebugging) {
                System.out.println(" lihat data ini tb_kostumer " + qry);
            }
            rs = sta.executeQuery(qry);
            java.util.Vector baris = null;
            ...
            while (rs.next()) {
                baris = new java.util.Vector();
                baris.addElement(rs.getString("kd_kos"));
                baris.addElement(fsu.ceknull(rs.getString("nama_kos")));
            ...
            if (fsu.idebugging) {
                System.out.println(" error enter tb_kostumer lihat " + ex.getMessage());
            }
        }
    ...
    private void lihat2() {
        ...
        kondisi = " where kd_brg not in (select kd_brg from tb_trxjual2 where kd_user=" + pemakai + " )";
    ...
    void lihattrx() {
        ...
        switch (kolompilihtx) {
            ...
            case 2:
                ...
                break;
            case 3:
                orderbi = " order by hrg_jual ";
                break;
            case 4:
                orderbi = " order by discount ";
                break;
            case 5:
                orderbi = " order by hrg_diskon ";
                break;
            case 6:
                orderbi = " order by stok ";
                break;
            case 7:
                orderbi = " order by totaljual ";
                break;
        }
        if (ascenditx) {
            orderbi += " ASC";
        ...
        String qry = "select urutan,nama_brg,kd_brg,hrg_jual,"
                + "stok,hrg_diskon,totaljual,discount from tb_trxjual2 a where kd_user = " + pemakai + orderbi;
        if (fsu.idebugging) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                baris.addElement(fsu.ceknullangka(rs.getString("hrg_jual")));
                baris.addElement(fsu.ceknullangka(rs.getString("discount")) + " %");
                baris.addElement(fsu.ceknullangka(rs.getString("hrg_diskon")));
                baris.addElement(fsu.ceknullangka(rs.getString("totaljual")));
                total += rs.getInt("totaljual");
